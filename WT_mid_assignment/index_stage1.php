...
<body>
     ...
     <form>
     	...
     	<tr>
     		...
     		<td width="30 px"></td>
     		<td><input style="width: 300px" type="id" id="id" placeholder="ID" required></td>
     	</tr>
		...
		<tr>
     	...
     	<tr>
     		...
     		<td width="30 px"></td>
     		<td>
			<input style="width: 30px" type="No" id="height" required ><b> cm</b>
     		<input style="width: 30px" type="No" id="height" required ><b> inch</b>
     		</td>
     	</tr>
     	...
     	<tr>
     		...
     		<td width="30 px"></td>
     		<td><input style="width: 300px" type="text" id="email" placeholder="Email Address" required></td>
     	</tr>

     	<tr>
     		<td colspan="2"><label>Father's Name:</label><b style="color: red">*</b></td>
     		<td><input style="width: 300px" type="text" id="Fathername" placeholder="FatherName" required></td>
     	...
     	<tr>
     		...
     		<td width="30 px"></td>
     		<td>
     			<input style="width: 300px" type="text" id="Mothername" placeholder="MotherName" required>
     		</td>
     	...
     	<tr>
     		...
     		<td><select style="width: 300px" name="SpProfession" required>
     				<option value="Select">-Select-</option>
     	...
     	<tr>
     		<td colspan="2"><label>Birth District:</label><b style="color: red">*</b><td><select style="width: 300px" name="Birth_District" required>
     				<option value="Select">-Select-</option>
     				<option value="Banani">Banani</option>
     				<option value="Bogra">Bogra</option>
     				<option value="Khulna">Khulna</option>
     	...
     	<tr>
     		<td width="10 px" colspan="3"></td>
     		<td colspan="2"><label>District:</label><b style="color: red">*</b><td><select style="width: 300px" name="District" required>
     				<option value="Select">-Select-</option>
     				<option value="Banani">Banani</option>
     				<option value="Bogra">Bogra</option>
     				<option value="Khulna">Khulna</option>
     	...
     	<tr>
     		<td width="10 px" colspan="3"></td>
     		<td colspan="2"><label>Post Office:</label><b style="color: red">*</b></td>
     		<td><select style="width: 300px" name="PostOffice" required>
     				<option value="Select">-Select-</option>
     				<option value="Banani">Banani</option>
     				<option value="Bogra">Dinajpur</option>
     				<option value="Khulna">Shahbag</option>
